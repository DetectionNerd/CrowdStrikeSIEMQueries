| Query File |
|-----------|
| [`1. Duo Authentication Attempt from Malicious IP`](./DuoAuthenticationAttemptfromMaliciousIP.cql) |
| [`2. Duo Authentication Attempt - MFA Device on Malicious IP`](./DuoAuthenticationAttempt-MFADeviceonMaliciousIP.cql) |
| [`3. Entra ID Sign-in Attempt from Malicious IP`](./EntraIDSign-inAttemptfromMaliciousIP.cql) |
...
| [`12. p Malicious Domain on Teams Chat`](./MaliciousDomainonTeamsChat.cql) |
| [`13. M365 (OneDrive, SharePoint, Teams) Activity from Malicious IP`](./M365(OneDrive-SharePoint-Teams)ActivityfromMaliciousIP.cql) |
| [`14. Malicious URL in Email`](./MaliciousURLinEmail.cql) |
| [`15.p  Malicious Domain in Email`](./MaliciousDomaininEmail.cql) |
